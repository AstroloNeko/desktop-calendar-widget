...
# 法定放假日仍以上方国务院年度安排为准。
_LUNAR_FESTIVALS = {
    2024: ((2, 9, "除夕", "除夕"), (2, 10, "春节", "春节"), (2, 24, "元宵节", "元宵"), (6, 10, "端午节", "端午"), (8, 10, "七夕", "七夕"), (9, 17, "中秋节", "中秋"), (10, 11, "重阳节", "重阳")),
    2025: ((1, 28, "除夕", "除夕"), (1, 29, "春节", "春节"), (2, 12, "元宵节", "元宵"), (5, 31, "端午节", "端午"), (8, 29, "七夕", "七夕"), (10, 6, "中秋节", "中秋"), (10, 29, "重阳节", "重阳")),
    2026: ((2, 16, "除夕", "除夕"), (2, 17, "春节", "春节"), (3, 3, "元宵节", "元宵"), (6, 19, "端午节", "端午"), (8, 19, "七夕", "七夕"), (9, 25, "中秋节", "中秋"), (10, 18, "重阳节", "重阳")),
    2027: ((2, 5, "除夕", "除夕"), (2, 6, "春节", "春节"), (2, 20, "元宵节", "元宵"), (6, 9, "端午节", "端午"), (8, 8, "七夕", "七夕"), (9, 15, "中秋节", "中秋"), (10, 8, "重阳节", "重阳")),
    2028: ((1, 25, "除夕", "除夕"), (1, 26, "春节", "春节"), (2, 9, "元宵节", "元宵"), (5, 28, "端午节", "端午"), (8, 26, "七夕", "七夕"), (10, 3, "中秋节", "中秋"), (10, 26, "重阳节", "重阳")),
    2029: ((2, 12, "除夕", "除夕"), (2, 13, "春节", "春节"), (2, 27, "元宵节", "元宵"), (6, 16, "端午节", "端午"), (8, 16, "七夕", "七夕"), (9, 22, "中秋节", "中秋"), (10, 15, "重阳节", "重阳")),
    2030: ((2, 2, "除夕", "除夕"), (2, 3, "春节", "春节"), (2, 17, "元宵节", "元宵"), (6, 5, "端午节", "端午"), (8, 5, "七夕", "七夕"), (9, 12, "中秋节", "中秋"), (10, 5, "重阳节", "重阳")),
}
...
def _official_2026(day: date) -> Optional[HolidayInfo]:
    ...
    for start, end, name, festival_day in _DAYS_OFF_2026:
        if start <= day <= end:
            short = name.removesuffix("节") if day == festival_day else "休"
            return HolidayInfo(name if day == festival_day else f"{name}假期", short, "day_off")
    return None
