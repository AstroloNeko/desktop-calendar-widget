...
MODERN = Theme(
    ...
    divider="#D8D7D2",
    header_background="#F7F6F2",
    header_gradient_start="#F7F6F2",
    header_gradient_mid="#F7F6F2",
    header_gradient_end="#F7F6F2",
    ...
    control_background="#F7F6F2",
    control_hover="#ECECF1",
    control_pressed="#DFE0E8",
    control_border="#D8D7D2",
    control_highlight="#FFFFFF",
    control_disabled="#EFEFEB",
    control_text="#777A83",
    calendar_background="#F7F6F2",
    weekday_text="#A9ABB2",
    date_text="#25262B",
    ...
    date_today_background="#F8F7FC",
    date_today_border="#7B86DC",
    date_event_indicator="#6273D9",
    date_weekend_text="#BC6B6B",
    date_selected_today="#B4BAEE",
...
WIN7_AERO = Theme(
    ...
    date_today_background="#FAFBF8",
    date_today_border="#A5CBCD",
    date_event_indicator="#5A9DAC",
    date_weekend_text="#986D70",
    date_selected_today="#9FCED1",
